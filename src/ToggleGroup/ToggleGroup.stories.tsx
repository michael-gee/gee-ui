...
OutlineDark.storyName = 'Outline (Dark)';
OutlineDark.parameters = darkModeParams;
OutlineDark.decorators = [withDarkMode];
...
SingleDark.storyName = 'Single (Dark)';
SingleDark.parameters = darkModeParams;
SingleDark.decorators = [withDarkMode];
